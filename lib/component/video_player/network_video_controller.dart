...
class NetworkVideoPlayerController extends BaseVideoPlayerController {
  final String networkPath;

  NetworkVideoPlayerController({this.networkPath}) {
    controller = VideoPlayerController.network(networkPath);
  }
